...
manual_torch_name_rule_map = {
    ...
    # torch._ops
    "torch._ops._to_flat_tuple": UserFunctionVariable,
    "torch._ops._compute_keyset": UserFunctionVariable,
    "torch._ops._get_tensors": UserFunctionVariable,
    "torch._ops.key_extractor": UserFunctionVariable,
    # pyfunctorch
    "torch._functorch.pyfunctorch.dispatch_functorch": UserFunctionVariable,
    "torch._functorch.pyfunctorch.retrieve_current_functorch_interpreter": UserFunctionVariable,
    "torch._functorch.pyfunctorch.coerce_cinterpreter": TorchInGraphFunctionVariable,
    "torch._functorch.autograd_function.custom_function_call_vmap": UserFunctionVariable,
    "torch._functorch.autograd_function.has_overriden_vmap_rule": UserFunctionVariable,
    "torch._functorch.autograd_function.custom_function_call_vmap_generate_rule": UserFunctionVariable,
    "torch._functorch.autograd_function.vmapify_autograd_function": UserFunctionVariable,
    # everything else
    ...
    "torch._functorch.autograd_function.reductify_leaf": UserFunctionVariable,
    "torch._functorch.autograd_function.reductify": UserFunctionVariable,
